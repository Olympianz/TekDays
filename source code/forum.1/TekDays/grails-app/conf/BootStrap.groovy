...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def m2 = new Message(subject:'I think I can get James Gosling to do a keynote', 
                             content:'message 2 content', author:user2, event:g1).save()
        ...
        def m3 = new Message(subject:'Can anyone recommend a good screen printer?', content:'message 3 content', author:user, event:g1).save()
    }
