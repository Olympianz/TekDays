...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def m1 = new Message(subject:'sub1', content:'message 1 content', author:user, event:g1).save()
        def m2 = new Message(subject:'sub2', content:'message 2 content', author:user, event:g1).save()
        def m2a = new Message(subject:'sub2a', content:'message 2a content', author:user, event:g1, parent:m2).save()
        def m2b = new Message(subject:'sub2b', content:'message 2b content', author:user, event:g1, parent:m2).save()
        def m2b1 = new Message(subject:'sub2b1', content:'message 2b1 content', author:user, event:g1, parent:m2b).save()
        def m3 = new Message(subject:'sub3', content:'message 3 content', author:user, event:g1).save()
    }
