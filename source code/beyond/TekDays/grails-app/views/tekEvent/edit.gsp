          ...
          <table>
            <tbody>
              ...
              <tr class="prop">
                ...
                <td valign="top" class="value 
                         ${hasErrors(bean:tekEventInstance,field:'city','errors')}">
              ...
              <tr class="prop">
                ...
                <td valign="top" class="value 
                    ${hasErrors(bean:tekEventInstance,field:'venue','errors')}">
              ...
              <tr class="prop">
                ...
                <td valign="top" class="value 
                  ...
                  <g:datePicker name="endDate" value="${tekEventInstance?.endDate}">
                  </g:datePicker>
                </td>
              </tr> 
              <tr class="prop">
              ...
              <tr class="prop">
                ...
                <td valign="top" class="value 
                    ${hasErrors(bean:tekEventInstance,field:'tasks','errors')}">
                  <ul>
              ...
              <tr class="prop">
                ...
                <td valign="top" class="value 
                    ${hasErrors(bean:tekEventInstance,field:'messages','errors')}">
                  <ul>
              ...
              <tr class="prop">
                ...
                <td valign="top" class="value 
                    ${hasErrors(bean:tekEventInstance,field:'respondents','errors')}">
                </td>
              </tr> 
            </tbody>
          </table>
